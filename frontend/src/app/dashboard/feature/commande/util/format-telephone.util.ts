...
/**
 * Normalise un numéro belge saisi librement :
 * - format international : « +32 (0)472 09 65 63 »
 * - format national : « 0472 09 65 63 »
 * Retourne null si vide ou sans chiffres.
 */
...
export function formatTelephoneBEOrEmpty(input: string | null | undefined): string {
  return formatTelephoneBE(input) ?? '';
}
